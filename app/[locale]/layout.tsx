...
export async function generateMetadata({
	...
	> = {
		en: {
			...
			description:
				"Open source memory, messaging, and task management MCP server. 10 tables, 35 tools. Free, self-hosted on Convex.",
		...
		fr: {
			...
			description:
				"Serveur MCP open source pour la m\u00e9moire, la messagerie et la gestion de t\u00e2ches multi-agents. 10 tables, 35 outils. Gratuit, auto-h\u00e9berg\u00e9 sur Convex.",
			ogTitle:
				"VantagePeers \u2014 M\u00e9moire partag\u00e9e pour agents Claude Code",
			ogDesc:
				"Serveur MCP open source. 35 outils, 10 tables. M\u00e9moire s\u00e9mantique, messagerie inter-agents, gestion de t\u00e2ches. Gratuit.",
		},
	};
