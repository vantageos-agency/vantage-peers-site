...
const content = {
	en: {
		...
		notes: [
			...
			"Last verified: May 2026. Pricing and feature data current as of this date — competitor terms change frequently, check each vendor's site for the latest.",
		],
		available: "Available",
	...
	fr: {
		...
		notes: [
			...
			"Derni\u00e8re v\u00e9rification : mai 2026. Donn\u00e9es de tarification et de fonctionnalit\u00e9s \u00e0 jour \u00e0 cette date \u2014 les conditions des concurrents changent fr\u00e9quemment, consultez le site de chaque \u00e9diteur pour la derni\u00e8re version.",
		],
