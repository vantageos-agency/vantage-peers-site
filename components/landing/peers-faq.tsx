...
const faqs = {
	en: [
		...
		},
		{
			...
			answer:
				"VantagePeers exposes 64 MCP tools. Any MCP-compatible agent can use them. Claude is the primary use case because of the Claude Code / Claude Desktop MCP support, but the protocol is open.",
		},
		{
