  ...
  en: {
    ...
    vsHiring: {
      ...
      rows: [
        ...
        ['Skills', '1 person, 1 profile', '16 teams, 81 agents, 273 skills'],
    ...
    vsJuniorSo: {
      ...
      rows: [
        ['What you get', '1 AI employee', '16 teams, 81 agents'],
  ...
  fr: {
    ...
    vsHiring: {
      ...
      rows: [
        ...
        ['Compétences', '1 personne, 1 profil', '16 équipes, 81 agents, 273 compétences'],
    ...
    vsJuniorSo: {
      ...
      headers: ['', 'Junior.so', 'VantageOS Team'],
      rows: [
        ['Ce que vous obtenez', '1 employé IA', '16 équipes, 81 agents'],
