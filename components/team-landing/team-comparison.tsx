  ...
  en: {
    ...
    vsHiring: {
      ...
      rows: [
        ...
        ['Skills', '1 person, 1 profile', '16 teams, 77 agents, 192 skills'],
    ...
    vsJuniorSo: {
      ...
      rows: [
        ['What you get', '1 AI employee', '16 teams, 77 agents'],
  ...
  fr: {
    ...
    vsHiring: {
      ...
      rows: [
        ...
        ['Compétences', '1 personne, 1 profil', '16 équipes, 77 agents, 192 compétences'],
    ...
    vsJuniorSo: {
      ...
      headers: ['', 'Junior.so', 'VantageOS Team'],
      rows: [
        ['Ce que vous obtenez', '1 employé IA', '16 équipes, 77 agents'],
