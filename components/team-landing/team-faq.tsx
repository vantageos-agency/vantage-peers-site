...
const faqs: Record<Locale, FaqItem[]> = {
  en: [
    ...
    { category: 'General', question: 'What exactly is VantageOS Team?', answer: 'A fully managed AI team service. You get access to 16 specialized departments (marketing, sales, dev, content, SEO, etc.) with 80 AI agents and 214 skills, all supervised by Laurent Perello.' },
    ...
    { category: 'General', question: 'Is this like hiring a virtual assistant?', answer: 'No. A virtual assistant is one person with limited skills. VantageOS Team is 16 specialized departments with 80 agents. And every output is reviewed by a C-level executive.' },
  ...
  fr: [
    ...
    { category: 'Général', question: 'Qu\'est-ce que VantageOS Team exactement ?', answer: 'Un service d\'équipe IA entièrement géré. Vous accédez à 16 départements spécialisés (marketing, vente, dev, contenu, SEO, etc.) avec 80 agents IA et 214 compétences, le tout supervisé par Laurent Perello.' },
    ...
    { category: 'Général', question: 'C\'est comme un assistant virtuel ?', answer: 'Non. Un assistant virtuel est une personne avec des compétences limitées. VantageOS Team, c\'est 16 départements spécialisés avec 80 agents. Et chaque résultat est revu par un dirigeant C-level.' },
