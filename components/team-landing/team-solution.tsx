...
const content = {
  en: {
    ...
    subtitle:
      '16 specialized teams. 77 agents. 192 skills. Every deliverable reviewed by a C-level tech executive with 25 years of experience. Not an algorithm. A person.',
    benefits: [
      {
        icon: Clock,
  ...
  fr: {
    ...
    subtitle:
      '16 \u00e9quipes sp\u00e9cialis\u00e9es. 77 agents. 192 comp\u00e9tences. Chaque livrable revu par un dirigeant tech avec 25 ans d\u2019exp\u00e9rience. Pas un algorithme. Une personne.',
    benefits: [
      {
        icon: Clock,
