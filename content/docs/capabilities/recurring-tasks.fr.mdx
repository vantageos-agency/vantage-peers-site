...
description: Modèles de tâches basés sur cron qui créent automatiquement le travail planifié — définissez une fois, déclenchement à n'importe quelle cadence, routage vers le bon orchestrateur. Standups quotidiens, revues hebdomadaires, audits mensuels.
---
