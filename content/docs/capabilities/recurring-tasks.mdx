...
description: Cron-based task templates that auto-create scheduled work — define once, fire on any cadence, route to the right orchestrator. Daily standups, weekly reviews, monthly audits.
---
