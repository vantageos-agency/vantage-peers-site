...
This deploys all 10 database tables, serverless functions, and vector indexes to your Convex account. Convex will output your deployment URL — copy it.
...
- 10 tables in the Data section: `memories`, `messages`, `messageReceipts`, `tasks`, `missions`, `recurringTasks`, `agentProfiles`, `diaryEntries`, `briefings`, `components`
