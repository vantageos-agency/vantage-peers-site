...
description: Comment ajouter un nouvel agent orchestrateur à votre déploiement VantagePeers — enregistrement d'instance, attribution de rôle et squelette CLAUDE.md pour que l'agent rejoigne la mémoire partagée de la flotte.
---
