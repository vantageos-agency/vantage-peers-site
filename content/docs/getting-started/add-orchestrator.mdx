...
description: How to add a new orchestrator agent to your VantagePeers deployment — instance registration, role assignment, and CLAUDE.md scaffolding so the agent joins the fleet's shared memory.
---
