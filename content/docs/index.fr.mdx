...
description: Le système d'exploitation open-source pour les équipes d'agents IA. Mémoire partagée, messagerie inter-agents, gestion de tâches, fix patterns, missions. 20 tables, 82 outils MCP, gratuit pour toujours.
---
