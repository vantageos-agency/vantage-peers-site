...
description: The open-source operating system for AI agent teams. Shared memory, inter-agent messaging, task management, fix patterns, missions. 20 tables, 82 MCP tools, free forever.
---
