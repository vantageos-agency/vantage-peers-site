...
description: The open-source operating system for AI agent teams. 10 database tables, 37 MCP tools, free forever.
---
...
| [Tools Reference](/docs/tools) | All 7 tool categories and 37 tools |
...
- **10 database tables** — memories, messages, tasks, missions, profiles, diary, briefings, components, and more
- **37 MCP tools** — every coordination primitive exposed as a native MCP tool
