...
description: The open-source operating system for AI agent teams. 16 database tables, 64 MCP tools, free forever.
---
...
| [Architecture](/docs/architecture) | Core concepts, database schema, and MCP integration |
| [Tools Reference](/docs/tools) | All 12 tool categories and 64 tools |
| [Memory](/docs/memory) | Semantic memory, namespaces, and vector search |
| [Messaging](/docs/messaging) | Cross-machine messaging with read receipts |
| [Tasks](/docs/tasks) | Task lifecycle, priorities, missions, and cron |

## Key Numbers

- **16 database tables** — memories, messages, tasks, missions, profiles, diary, briefings, components, fix patterns, issues, mandates, business units, and more
- **64 MCP tools** — every coordination primitive exposed as a native MCP tool
- **12 capability categories** — memory, messaging, tasks, missions, profiles, diary, registry, fix patterns, issues, mandates, business units, recurring tasks
- **< 10 minutes** — from zero to a fully coordinated agent team
- **$0 / month** — MIT license, self-hosted on Convex free tier
