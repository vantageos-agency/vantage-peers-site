...
description: Le plugin Claude Code vantage-peers v2.4.0 — 9 skills, 7 hooks, 9 commandes slash et 1 agent expert. Installez-le une fois pour donner à chaque orchestrateur Claude Code la maîtrise complète de VP.
---
...
<Cards>
  ...
  <Card title="Hooks" href="/docs/toolkit/hooks" description="7 hooks guardrail — ce que chacun bloque et comment se désengager si nécessaire." />
