...
description: All 64 MCP tools across 12 capability categories in VantagePeers.
---

# Tools Reference

VantagePeers exposes 64 MCP tools organized into 12 capability categories. Every tool accepts and returns JSON. All values are lowercase strings unless noted.
...
| [Messaging](#messaging-tools) | 5 | Send messages across machines with read receipts |
...
| [GitHub Issues](#github-issue-tools) | 9 | Issue tracking with webhook sync |
...
Cross-agent service requests with budget tracking. See [Mandates](/docs/mandates) for full documentation.
...
Track organizational units with strategy and KPIs. See [Business Units](/docs/business-units) for full documentation.
...
Issue tracking with webhook sync and auto-linking. See [GitHub Issues](/docs/issues) for full documentation.
...
Bug fix knowledge base with semantic search. See [Fix Patterns KB](/docs/fix-patterns) for full documentation.
...
| `link_issue_to_pattern` | Link an issue to a pattern |
