...
description: All 37 MCP tools across 7 capability categories in VantagePeers.
---

# Tools Reference

VantagePeers exposes 37 MCP tools organized into 7 capability categories. Every tool accepts and returns JSON. All values are lowercase strings unless noted.
